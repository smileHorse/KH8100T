...
void
IceProxy::TransferFileSpace::TransferFile::sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::Ice::Context* __ctx)
{
...
::Ice::AsyncResultPtr
IceProxy::TransferFileSpace::TransferFile::begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
...
TransferFileSpace::TransferFile::___sendRdbLoggerBinary(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    __is->read(__p_datas);
    __inS.endReadParams();
    sendRdbLoggerBinary(__p_title, __p_datas, __current);
    __inS.__writeEmptyParams();
    return ::Ice::DispatchOK;
}
...
{
    ::std::pair< const ::std::string*, const ::std::string*> r = ::std::equal_range(__TransferFileSpace__TransferFile_all, __TransferFileSpace__TransferFile_all + 12, current.operation);
    if(r.first == r.second)
    {
