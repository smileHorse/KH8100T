...
public:
    ...
    void sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas)
    {
        sendRdbLoggerBinary(__p_title, __p_datas, 0);
    }
    void sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::Ice::Context& __ctx)
    {
        sendRdbLoggerBinary(__p_title, __p_datas, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_sendRdbLoggerBinary(__p_title, __p_datas, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_sendRdbLoggerBinary(__p_title, __p_datas, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_sendRdbLoggerBinary(__p_title, __p_datas, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_sendRdbLoggerBinary(__p_title, __p_datas, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas)
    {
        return begin_sendRdbLoggerBinary(__p_title, __p_datas, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::Ice::Context& __ctx)
    {
        return begin_sendRdbLoggerBinary(__p_title, __p_datas, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_sendRdbLoggerBinary(__p_title, __p_datas, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_sendRdbLoggerBinary(__p_title, __p_datas, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::TransferFileSpace::Callback_TransferFile_sendRdbLoggerBinaryPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_sendRdbLoggerBinary(__p_title, __p_datas, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_sendRdbLoggerBinary(const ::std::string& __p_title, const ::TransferFileSpace::Bytes& __p_datas, const ::Ice::Context& __ctx, const ::TransferFileSpace::Callback_TransferFile_sendRdbLoggerBinaryPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_sendRdbLoggerBinary(__p_title, __p_datas, &__ctx, __del, __cookie);
    }
...
private:
    ...
    void sendRdbLoggerBinary(const ::std::string&, const ::TransferFileSpace::Bytes&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_sendRdbLoggerBinary(const ::std::string&, const ::TransferFileSpace::Bytes&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual void sendRdbLoggerBinary(const ::std::string&, const ::TransferFileSpace::Bytes&, const ::Ice::Current& = ::Ice::Current()) = 0;
