...
module RdbWarningData
{
	...
	//RelayEvent 保护事项, FaultEvent 故障事项, FaEvent FA告警, GraphEvent 画面事项, AllEvent所有告警事项(客户端查询时用)
	enum RdbWarningType {LimitEvent,SoeEvent,YxEvent,UnitEvent,SysEvent,OperEvent,RelayEvent,FaultEvent,FaEvent,WaveEvent,GraphEvent, AllEvent};//告警类型
